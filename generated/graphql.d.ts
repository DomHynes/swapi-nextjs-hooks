...
export type Film_DetailQueryVariables = {
  id?: Maybe<Scalars["ID"]>;
};

export type Film_DetailQuery = { __typename?: "Query" } & {
  Film: Maybe<
    { __typename?: "Film" } & Pick<Film, "id" | "title" | "releaseDate"> & {
        characters: Maybe<
          Array<
            { __typename?: "Person" } & Pick<Person, "name"> & {
                _filmsMeta: { __typename?: "_QueryMeta" } & Pick<
                  _QueryMeta,
                  "count"
                >;
                species: Maybe<
                  Array<{ __typename?: "Species" } & Pick<Species, "name">>
                >;
                homeworld: Maybe<
                  { __typename?: "Planet" } & Pick<Planet, "name">
                >;
              }
          >
        >;
...
export type TestQuery = { __typename?: "Query" } & {
  allFilms: Array<{ __typename?: "Film" } & Pick<Film, "id" | "title">>;
};

declare module "*/GetFilmDetail.gql" {
  import { DocumentNode } from "graphql";
  const defaultDocument: DocumentNode;
  export const FILM_DETAIL: DocumentNode;

  export default defaultDocument;
}

declare module "*/GetMovies.gql" {
  import { DocumentNode } from "graphql";
  const defaultDocument: DocumentNode;
